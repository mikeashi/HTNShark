...
public abstract class Method extends DomainElement {
  ...
  /**
   * A double value to store the estimation factor of this method.
   */
  ...
  /**
   * To get the estimation factor of this method.
   * 
   * @return double value of the estimation factor.
   */
  ...
  /**
   * To set the estimation factor of this method.
   * 
   * @param value double value of the estimation factor.
   */
  public void setEstimationFactor(double value) {
    estimationFactor = value;
  }
