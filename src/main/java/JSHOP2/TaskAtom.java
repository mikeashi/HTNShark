 ...
 * @author <a href=
 *         "http://www.cs.umd.edu/~okhtay">http://www.cs.umd.edu/~okhtay</a>
 * @version 1.0.3
 */
public class TaskAtom extends CompileTimeObject {
  ...
  /**
   * Whether a cycle is detected in the task network that contains this task
   */
  private boolean isCycle;

  /**
   * The utility of this task atom.
   */
   ...
   *                    the task atom itself.
   * @param immediateIn
   *                    whether or not this task atom is marked
   *                    <code>:immediate</code>.
   * @param primitiveIn
  ...
  /**
   * This function is used to get the value of the field <code>isCycle</code>.
   * 
   * @return the value of the field <code>isCycle</code>.
   */
  ...
  /**
   * This function is used to set the value of the field <code>isCycle</code>.
   * 
   * @param isCycle
   *          the value to be set for the field <code>isCycle</code>.
   */
  ...
  /**
   * This function is used to get the value of the field <code>utility</code>.
   * 
   * @return the value of the field <code>utility</code>.
   */
  ...
  /**
   * This function is used to set the value of the field <code>utility</code>.
   * 
   * @param utility
   *          the value to be set for the field <code>utility</code>.
   */
